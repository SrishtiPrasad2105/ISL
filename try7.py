...
class SignLanguageApp:
    def __init__(self, root):
        ...
        # Add tags for text alignment and background colors with curved borders and custom font
        self.text_display.tag_configure("left", justify='left', background="#E1D5E7", lmargin1=10, lmargin2=10, rmargin=200, spacing3=10, font=("Helvetica", 14, "italic"))
        self.text_display.tag_configure("right", justify='right', background="#6A1B9A", foreground="white", lmargin1=200, lmargin2=10, rmargin=10, spacing3=10, font=("Helvetica", 14, "bold"))
        self.text_display.tag_configure("bubble_right", wrap=tk.WORD)
    ...
    def text_to_speech(self):
        if not self.speech_active or self.stop_speech:
            return
