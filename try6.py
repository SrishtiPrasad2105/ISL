...
class SignLanguageApp:
    def __init__(self, root):
        ...
        # Add tags for text alignment and background colors with curved borders
        self.text_display.tag_configure("left", justify='left', background="#E1D5E7", lmargin1=10, lmargin2=10, rmargin=10, spacing3=10)
        self.text_display.tag_configure("right", justify='right', background="#6A1B9A", foreground="white", lmargin1=10, lmargin2=10, rmargin=10, spacing3=10)
